...
// MIRcatSDK.h
//
// Copyright © 2023 Daylight Solutions, Inc.
//
...
extern "C"
{
   ...
   // New functions related to supporting multiple MIRcats
    ...
    *	Gets the system firmware versions.
    *
    *	Parameters:
    *		cbFwMaj - (out) Control Board Major FW Version Number.
    *		cbFwMin - (out) Control Board Minor FW Version Number.
    *		cbFwPatch - (out) Control Board Patch FW Version Number.
    *		mbFwMaj - (out) Motion Board Major FW Version Number.
    *		mbFwMin - (out) Motion Board Minor FW Version Number.
    *		mbFwPatch - (out) Motion Board Patch FW Version Number.
    *
    *	Returns:
    *		MIRcatSDK_RET_SUCCESS - If retrieving the firmware versions is
    *successful. MIRcatSDK_RET_NOT_INITIALIZED - If the controller is not yet
    *initialized.
    */
