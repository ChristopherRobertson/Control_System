...
stable phase directory under `calibration/system_recalibration_001/readbacks/`.
...
[daylight_db9_process_trigger_correspondence.md](MIRcat/daylight_db9_process_trigger_correspondence.md).
