...
- Service: `software/control_app/devices/ell15_iris_service.py`
- Discovery support: `software/control_app/devices/serial_support.py`
- Tests: `software/tests/test_ell15_iris_service.py` and
