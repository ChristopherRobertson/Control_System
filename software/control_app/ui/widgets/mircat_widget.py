...
MIRCAT_WIDGET_SPEC = DeviceWidgetSpec(
    ...
    parameter_fields=(
        ...
        ParameterField("scan_trigger_width_ns", "T660-1 Trigger Width", "float", 150., units="ns", minimum=21, maximum=1005),
        ParameterField("scan_internal_rate_hz", "MIRcat Internal Rate", "float", 2100000., units="Hz", minimum=1),
        ParameterField("scan_internal_width_ns", "MIRcat Internal Width", "float", 142., units="ns", minimum=21, maximum=1005),
        ParameterField(
            "pulse_rate_hz",
