...
class FixedPointPanel(CompactMeasurementPanel):
    ...
    def __init__(self, context):
        ...
        self.left_layout.setContentsMargins(6, 3, 6, 3)
        self.left_layout.setSpacing(3)
        finish_actions = QHBoxLayout()
        finish_actions.setSpacing(3)
        for button in (self.abort_button, self.new_run_button):
            self.action_layout.removeWidget(button)
            finish_actions.addWidget(button)
        self.action_layout.addLayout(finish_actions)
