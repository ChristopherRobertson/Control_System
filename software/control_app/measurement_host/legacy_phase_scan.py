"""Compatibility boundary for the two established Phase Scan tabs.

Their scientific runners, saved-plan schemas and native folder layout remain
unchanged. Only lifecycle and preference scope are adapted here. New methods
register independently in measurement_modules, never in this adapter.
"""
...
def create_phase_scan_tabs(context, *, single_runner=None, dual_runner=None,
    ...
    for mode, title, runner in (
        ...
        widget = PhaseScanWidget(
            ...
            before_start=(lambda r=runner: before_start(hardware=bool(getattr(r, "hardware_access", False))))
