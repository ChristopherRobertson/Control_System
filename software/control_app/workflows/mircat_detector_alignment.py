...
HF2LI_PRESETS_PATH = "instrument/recipes/hf2li_presets.yaml"
MAX_DUTY_CYCLE = 0.30
MIRCAT_WAVENUMBER_MIN_CM1 = 1638.8
MIRCAT_WAVENUMBER_MAX_CM1 = 2077.3
ALIGNMENT_TIMING_RECIPE = "instrument/recipes/mircat_detector_alignment_2mhz.yaml"
SAFE_IDLE_RECIPE = "instrument/recipes/safe_idle.yaml"
        ...
        try:
            ...
            if request.use_t660_timing:
                ...
                safe_idle_readback = timing_manager.apply_recipe(
                    resolve_compat_path(SAFE_IDLE_RECIPE),
            ...
            if request.use_t660_timing:
                ...
                alignment_readback = timing_manager.apply_recipe(
                    resolve_compat_path(request.timing_recipe),
        ...
        if self.t660_running or self.uses_t660_timing:
            try:
                ...
                timing_manager.apply_recipe(
                    resolve_compat_path(SAFE_IDLE_RECIPE), output_path=safe_idle_path
                )
                self.t660_running = False
