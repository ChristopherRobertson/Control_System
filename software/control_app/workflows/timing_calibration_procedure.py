...
DEFAULT_OPTICAL_RECIPE = "instrument/recipes/ndyag_alignment_10hz.yaml"
...
MEASUREMENT_STEPS: tuple[MeasurementStep, ...] = (
    MeasurementStep(
        ...
        splitter_used=True,
        splitter_mapping="integral branch S1 -> directly to CHA; integral branch S2 -> directly to CHB; third integral branch -> open and unconnected",
        ...
        notes="There are no intervening measurement cables or adapters between integral branches S1/S2 and the PicoScope in Steps 0a/0b.",
    ...
    MeasurementStep(
        ...
        uses_final_wiring=False,
        splitter_used=True,
        splitter_mapping="integral branch S2 -> directly to CHA; integral branch S1 -> directly to CHB; third integral branch -> open and unconnected",
...
class TimingCalibrationProcedure:
    ...
    def build_plan(
        ...
        *,
        ...
        picoscope_recipe_path: str | Path = "instrument/recipes/picoscope_settings_test.yaml",
        ...
        return {
            ...
            "analysis": {
                ...
                "timebase_accuracy_source": "references/manuals/PicoScope/PicoScope 5000D Series Data Sheet.pdf, p. 17, PicoScope 5244D initial timebase accuracy +/-2 ppm",
...
def create_unique_run_directory(
    *,
    ...
    if not parent.is_absolute():
        parent = resolve_compat_path(parent)
    ...
    *,
    ...
    corrections["uncertainty_provenance"] = {
        "picoscope_initial_timebase_accuracy": {
            ...
            "source": "references/manuals/PicoScope/PicoScope 5000D Series Data Sheet.pdf, p. 17, PicoScope 5244D",
...
def _render_consolidated_markdown(
    ...
    lines = [
        ...
        "PicoScope timebase term: 2 ppm initial accuracy included in fixed/derived combined uncertainties and slope uncertainty; source: `references/manuals/PicoScope/PicoScope 5000D Series Data Sheet.pdf`, p. 17, PicoScope 5244D. Annual drift remains separately reviewable unless covered by the run's calibration record.",
        "",
...
def _resolve_repo_path(path: str | Path) -> Path:
    target = Path(path)
    return target if target.is_absolute() else resolve_compat_path(target)
