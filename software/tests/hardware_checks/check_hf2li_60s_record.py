...
Usage:
    python software/tests/hardware_checks/check_hf2li_60s_record.py --operator "Name" --confirm-real-hardware
...
def parse_args() -> argparse.Namespace:
    ...
    parser.add_argument("--presets-path", default="instrument/recipes/hf2li_presets.yaml")
