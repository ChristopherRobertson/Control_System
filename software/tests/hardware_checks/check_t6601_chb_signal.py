...
def main() -> int:
    ...
    with command_log_path.open("a", encoding="utf-8") as command_log:
        ...
        try:
            ...
            manager.apply_recipe(REPO_ROOT / "instrument" / "recipes" / "safe_idle.yaml", output_path=safe_before_path)
            ...
            try:
                ...
                manager.apply_recipe(REPO_ROOT / "instrument" / "recipes" / "safe_idle.yaml", output_path=safe_after_path)
    ...
    manifest = new_manifest(
        ...
        inventory=inventory,
        t660_recipes=["instrument/recipes/safe_idle.yaml", SIGNAL_RECIPE],
