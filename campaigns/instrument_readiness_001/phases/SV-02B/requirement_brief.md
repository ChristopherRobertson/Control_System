...
- **[R11]** [`instrument/recipes/mircat_sweep_scan.yaml`](../../../../instrument/recipes/mircat_sweep_scan.yaml)
  and [`instrument/recipes/hf2li_presets.yaml`](../../../../instrument/recipes/hf2li_presets.yaml),
  provisional design settings inspected only to identify qualification needs.
- **[R12]** [`docs/operating_procedures/mircat_sweep_scan_workflow.md`](../../../../docs/operating_procedures/mircat_sweep_scan_workflow.md),
  active-segment, marker, direction, streaming, and abort rules.
- **[R13]** [`instrument/hardware_configuration.yaml`](../../../../instrument/hardware_configuration.yaml),
  [`instrument/wiring_map.yaml`](../../../../instrument/wiring_map.yaml), and current device
  services/workflow under `software/control_app/`, used to verify installed topology and
  current control behavior, not as approved campaign recipes.
- **[R14]** [`references/manuals/MIRcat/daylight_db9_process_trigger_correspondence.md`](../../../../references/manuals/MIRcat/daylight_db9_process_trigger_correspondence.md),
...
- **[R18]** Characterization data-retention templates under
  `campaigns/templates/phase_record/`: phase manifest,
...
- **[M4]** VIGO Photonics, *SIP series preamplifiers datasheet*,
  ...
  local installed package source: `references/manuals/Detectors/MIDIR-Detector-Package.pdf`.
- **[M5]** Zurich Instruments, *HF2 User Manual*, current
  ...
  `references/manuals/HF2LI/Zurich Insturments HF2LI User Manual.pdf`. Also used:
  `references/manuals/HF2LI/Zurich Instruments LabOne API User Manual.pdf` for continuous
...
- **[M6]** Daylight Solutions, *MIRcat Ultra-Broadly Tunable Mid-IR Laser User
  ...
  `references/manuals/MIRcat/Daylight Solutions MIRcat Manual.pdf`; searchable public
...
- **[M7]** Highland Technology, *T660 Manual*, hardware revision F / firmware
  ...
  `references/manuals/T660/Highland Technologies T660 Manual.pdf`; manufacturer
...
- **[M8]** Highland Technology, *T660 Programming Guide* (2025), local source
  `references/manuals/T660/Highland Technologies T660 Programming Guide.pdf`.
...
- **[M10]** Daylight Solutions, *Getting Started with the MIRcatSDK*, local
  direct source `references/sdk/MIRcat/MIRcatSDKGuide.pdf`, used for initialization,
