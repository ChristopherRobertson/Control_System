...
def main() -> int:
    ...
    dependencies = {
        "S0": PHASE_ROOT / "S0/s0_record.json",
        "MS-01": PHASE_ROOT / "MS-01/ms01_results.json",
        "MS-02": PHASE_ROOT / "MS-02/ms02_results.json",
        "T2-01": PHASE_ROOT / "T2-01/t2_01_results.json",
        "CH-00": PHASE_ROOT / "CH-00/phase_manifest.json",
    }
