"""Apply and verify T660-only safe idle before resumed MC-01 active testing."""
...
def main() -> int:
    status_path = HERE / "continuation_safe_idle_status.json"
    record = {
