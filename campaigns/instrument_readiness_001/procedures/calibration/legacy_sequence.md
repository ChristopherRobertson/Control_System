...
> **Unified-order amendment:** `campaigns/phase_registry.yaml` is the sole
> prospective dependency authority and
> `campaigns/master_sequence.md` is its human-readable view.
...
5. Under `instrument/default_wiring_state.md`, `default wiring restored` means
...
shared contract in `docs/data_contract/measurement_campaign_data_contract.md`. Before a
...
`evidence/characterization/system_characterization_001` may be planned in parallel but
