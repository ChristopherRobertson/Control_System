...
> **Unified-order amendment:** `campaigns/phase_registry.yaml` is the phase
...
- `campaigns/instrument_readiness_001/phases/SV-02B/requirement_brief.md`;
- `campaigns/hrp_001/requirements.md`; and
