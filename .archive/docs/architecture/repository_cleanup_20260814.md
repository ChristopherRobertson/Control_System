...
- Generic hardware checks write to `evidence/experiments/runs/`. Their outputs are operational
...
- The generic experiment-builder YAML was moved under `software/tests/fixtures/`; it is
