...
Each phase evidence root must contain `procedural_writeup.md` before documentation
closeout. It must follow `../docs/data_contract/procedural_writeup_standard.md`, be
