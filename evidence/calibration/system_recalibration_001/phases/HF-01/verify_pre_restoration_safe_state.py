"""Verify electronic safe idle immediately before HF-01 timing-cable restoration."""
...
STATUS = RAW / "hf01_pre_restoration_safe_state_001.json"
T660_READBACK = RAW / "hf01_pre_restoration_t660_safe_idle_001.json"
ACQUISITION_ID = "HF01-PRE-RESTORATION-SAFE-STATE-001"
...
def main() -> int:
    ...
    record: dict[str, object] = {
        ...
        "status": "STARTED",
        "physical_scope": (
            "electronic readback immediately before timing-cable restoration; "
            "physical wiring state remains established only by operator observation"
        ),
    }
